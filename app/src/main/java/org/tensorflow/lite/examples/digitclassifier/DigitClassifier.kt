...
class DigitClassifier(private val context: Context) {
  ...
  private fun classify(bitmap: Bitmap): Pair<Int, Float> {
    if (!isInitialized) {
    ...
    return Pair(maxIndex, result[0][maxIndex])
//    getOutputString(result[0])
  }

  fun classifyAsync(bitmap: Bitmap): Task<Pair<Int, Float>> {
